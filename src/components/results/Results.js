...
const nextSteps = (
  <section>
    <p>There are a few options on how you can proceed.</p>
    <br />
    <p>
      You may represent yourself in court. This is called Pro Se representation.
      If you do not qualify for legal aid, and you are unable to afford a
      lawyer, this is your best option. To get an idea of whether or not you
      qualify for aid, take a look at <a href='https://lasoregon.org/'>this</a>{' '}
      resource. For information on representing yourself, please take a look at
      our resources.
    </p>
    <br />
    <p>
      If you do not want to represent yourself, but are unable to afford a
      lawyer, you may qualify for legal aid based on a few factors. If you would
      like to, you can provide us with a little more personal information about
      yourself, and we will try to match you with a lawyer in your area. This is
    ...
    <p>
      ...
      provided to them. This should speed up the amount of time it takes a
...
export default function Results() {
  ...
  if (answers.q2.includes('emergency')) {
    toDisplay.push(
      <p key='emergency'>
        You indicated that you are in immediate danger. Call 911 as soon as
        possible. If possible, get to a safe place until authorities arrive.
      </p>
    );
  }
